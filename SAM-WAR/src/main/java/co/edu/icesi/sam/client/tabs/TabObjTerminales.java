...
import co.edu.icesi.sam.client.dialogos.agregar.DialogoAgregarObjTerminal;
import co.edu.icesi.sam.client.dialogos.editar.DialogoEditarObjTerminal;
...
public class TabObjTerminales extends TabItem
{
    ...
    public TabObjTerminales( )
    {
        ...
        gridObjTerminales = new Grid<ObjetivoTerminalModel>( new ListStore<ObjetivoTerminalModel>( ), getColumnModel( ) );
    ...
    {
        gridObjTerminales.addListener( Events.CellDoubleClick, new Listener<GridEvent<ObjetivoTerminalModel>>( )
        {
            @Override
            public void handleEvent( GridEvent<ObjetivoTerminalModel> e )
            {
                ObjetivoTerminalModel model = e.getGrid( ).getSelectionModel( ).getSelectedItem( );
    ...
    public void editarObjTerminal( String nombre, String contenido )
    {
        ...
        competenciasService.editarObjTerminal( objTerminal, new AsyncCallback<Integer>( )
        {
            @Override
            public void onSuccess( Integer result )
            {
    ...
    {
        int idCurso = Registry.get( "idCurso" );
        listadosService.listarObjTerminalesPorCurso( idCurso, new AsyncCallback<List<ObjetivoTerminalBO>>( )
        {
            @Override
            public void onSuccess( List<ObjetivoTerminalBO> result )
            {
                Dispatcher.forwardEvent( DTEvent.LISTAR_OBJ_TERMINALES, result );
            }
    ...
    public void actualizarTablaObjTerminales( ListStore<ObjetivoTerminalModel> objTerminales )
    {
