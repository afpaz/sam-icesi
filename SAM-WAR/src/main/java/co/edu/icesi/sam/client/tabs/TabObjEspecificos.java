...
import co.edu.icesi.sam.client.dialogos.agregar.DialogoAgregarObjEspecifico;
import co.edu.icesi.sam.client.dialogos.editar.DialogoEditarObjEspecifico;
    ...
    private void eventoSeleccionarMetaTerminal( )
    {
        gridMetasTerminales.addListener( Events.OnClick, new Listener<GridEvent<MetaTerminalModel>>( )
        {
            public void handleEvent( GridEvent<MetaTerminalModel> be )
            {
                ...
                Info.display( "SAM", MultiLingualConstants.msgSeleccionarMetaTerminal( ) + " " + model.getNombreUnidad( ) + " - " + model.getNombreObjTerminal( ) );
            }
        } );
    }
